...
namespace ShareSmile
{
    ...
    /// </summary>
    public sealed partial class EditDriverProfile : Page
    {
        ...
        private void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            txtAdrl_1.Text = driver.Address_Line_1;
            txtAdrl_2.Text = driver.Address_Line_2;
            ...
            txtFirst_Name.Text = driver.F_Name;
            txtLast_Name.Text = driver.L_Name;

            if (driver.Mobile_Alternate != null)
                txtMobile_Alternate.Text = driver.Mobile_Alternate;
            else
                txtMobile_Alternate.Text = "";

            txtMobile_Number.Text = driver.Mobile_Number;

            Area area = allareas.Where(x => x.Area_Id == driver.Area_Id).FirstOrDefault();
        ...
        private void Save_Click(object sender, RoutedEventArgs e)
        {
            if (ValidProfile())
            {
                ...
                edriver.Driver_Id = driver.Driver_Id;
                edriver.Account_Status = driver.Account_Status;
                edriver.Address_Line_1 = txtAdrl_1.Text;
                edriver.Address_Line_2 = txtAdrl_2.Text;
                edriver.Area_Id = ((Area)cbArea.SelectedItem).Area_Id;
                edriver.Email = txtEmail.Text;
                edriver.F_Name = txtFirst_Name.Text;
                edriver.L_Name = txtLast_Name.Text;
                edriver.Mobile_Alternate = txtMobile_Alternate.Text;
                edriver.Mobile_Number = txtMobile_Number.Text;
                edriver.Password = driver.Password;
                edriver.Save_Driver();
            }
        }
        ...
        public bool ValidProfile()
        {
            ...
            tblMobile_Error.Text = RegexValidation.Check_Mobile(txtMobile_Number.Text, "driver", driver.Driver_Id);
            register = tblMobile_Error.Text != "" ? false : register;

            if (txtMobile_Alternate.Text != "")
                tblMobile_Alternate_Error.Text = RegexValidation.Check_Mobile(txtMobile_Alternate.Text, "driver", driver.Driver_Id);
            ...
            if (txtEmail.Text != "")
                tblEmail_Error.Text = RegexValidation.Check_Email(txtEmail.Text, "driver", driver.Driver_Id);
