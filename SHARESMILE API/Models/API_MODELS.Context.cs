...
namespace SS_DB_API.Models
{
    ...
    public partial class ShareSmileDatabaseEntities : DbContext
    {
        public ShareSmileDatabaseEntities()
            : base("name=ShareSmileDatabaseEntities")
        {
        }
        ...
        public virtual DbSet<NGO_DRIVER> NGO_DRIVER { get; set; }
